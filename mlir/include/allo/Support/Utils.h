...
#ifndef ALLO_ANALYSIS_UTILS_H
#define ALLO_ANALYSIS_UTILS_H
...
template <> struct DenseMapInfo<mlir::allo::PtrLikeMemRefAccess> {
  static mlir::allo::PtrLikeMemRefAccess getEmptyKey() {
    auto pointer = llvm::DenseMapInfo<void *>::getEmptyKey();
    return mlir::allo::PtrLikeMemRefAccess(pointer);
  }
  static mlir::allo::PtrLikeMemRefAccess getTombstoneKey() {
    auto pointer = llvm::DenseMapInfo<void *>::getTombstoneKey();
    return mlir::allo::PtrLikeMemRefAccess(pointer);
  }
  static unsigned getHashValue(mlir::allo::PtrLikeMemRefAccess access) {
    return access.getHashValue();
  }
  static bool isEqual(mlir::allo::PtrLikeMemRefAccess lhs,
                      mlir::allo::PtrLikeMemRefAccess rhs) {
    return lhs == rhs;
  }
};
} // namespace llvm

...
class Schedule(Generic[P, R]):
    ...
    def unroll(
        self, targets: Targets = ..., *, factor: int = 0, tag_only: bool = False
    ) -> Schedule[P, R]: ...
    def partition(
        self, targets: Targets, *, dim: int = 0, kind=Complete, factor: int = 0
    ) -> Schedule[P, R]: ...
    def dataflow(self, targets: Targets = ...) -> Schedule[P, R]: ...
